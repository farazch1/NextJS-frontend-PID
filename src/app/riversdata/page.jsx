...
export default function RiversData() {
  ...
  const orderedKeys = data.length > 0 
    ...
    <Layout>
      <div className="max-h-96 overflow-y-scroll bg-white pb-2 pl-2 pr-2 rounded-lg shadow-md">
        <div className="mt-2 pb-2 sticky top-0 flex bg-white flex-wrap gap-2 items-center">
          ...
          {/* Reach Selector */}
          <div className="flex flex-col">
            <label htmlFor="reach" className="text-sm text-gray-600">Reach</label>
            <select
              id="reach"
          ...
          {reach === "Tarbela_to_Chashma" && (
            <div className="flex flex-col">
              <label htmlFor="rivSelection_tc" className="text-sm text-gray-600">Location</label>
              <select
                id="rivSelection_tc"
                className="bg-slate-300 p-1 rounded-lg focus:ring focus:bg-white cursor-pointer"
          ...
          {reach === "Taunsa_to_Guddu" && (
            <div className="flex flex-col">
              <label htmlFor="rivSelection_tg" className="text-sm text-gray-600">Location</label>
              <select
                id="rivSelection_tg"
                className="bg-slate-300 p-1 rounded-lg focus:ring focus:bg-white cursor-pointer"
